		...
		<div class="row-fluid">
			...
			<div id="content" class="span10">
				...
				<ul class="breadcrumb">
					...
					<li><a href="#">Data Pasien RSUD Curup</a>
						<i class="icon-angle-right"></i>
					</li>
					<li>
				...
				<div class="row-fluid sortable">
					<div class="box span12">
						...
						<div class="box-content">
							...
							$tampilEdit= "SELECT * FROM `pasien` WHERE id=".$id_pasienEdit;
							$queryEdit=mysqli_query($link,$tampilEdit);
							$dataEdit = mysqli_fetch_array($queryEdit);
							?>   

							<!--FORM START -->
							<form class="form-horizontal" action=<?php echo "proses_edit_pasien.php?id=".$_GET['id'] ?> method="POST">
								<fieldset>
									...
									<div class="form-actions">
										...
										<button class="btn"> <a style="text-decoration: none;color:#FFFFFF" href="index.php">Cancel</a></button>
									</div>
								</fieldset>
							</form>
