		...
		<div class="row-fluid">
			...
			<div id="content" class="span10">
				...
				<ul class="breadcrumb">
					...
					<li><a href="#">Data Pasien RSUD Curup</a></li>
				</ul>
						...
						<div class="box-content">
							<table class="table table-striped table-bordered bootstrap-datatable datatable">
								...
								<tbody>
									...
									require "connect.php";
									$i=0;
									$tampil="SELECT * FROM pasien ORDER BY id DESC";
									...
									while($data = mysqli_fetch_array($query)){
										...
										<a class='btn btn-info' href='edit_pasien.php?id=".$data['id']."'>
										<i class='halflings-icon white edit'></i>  
										</a>

										<a class='btn btn-danger' onclick='return ConfirmDelete();'  href='proses_delete_pasien.php?id=".$data['id']."'>
